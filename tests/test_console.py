#!/usr/bin/python3
"""The unittests for testing console.py
...
class TestHBNBCommand_prompting(unittest.TestCase):
    """The unittests testing prompting of HBNB command interpreter"""

    def test_prompt_string(self):
        self.assertEqual("(hbnb) ", HBNBCommand.prompt)

    def test_the_empty_line(self):
...
class TestHBNBCommand_help(unittest.TestCase):
    """The unittests testing help messages of HBNB command interpreter"""

    def test_the_help_quit(self):
...
class TestHBNBCommand_exit(unittest.TestCase):
    """The unittests testing the exit from the HBNB command interpreter"""

    def test_that_quit_exits(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertTrue(HBNBCommand().onecmd("quit"))

    def test_that_EOF_exits(self):
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_create(unittest.TestCase):
    """
    The unittests testing the create method
    ...
    def test_create_the_missing_class(self):
        missing_class_error = "** class name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_create_the_invalid_syntax(self):
        missing_class_error = "*** Unknown syntax: MyModel.create()"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("MyModel.create()"))
            self.assertEqual(missing_class_error, output.getvalue().strip())
            missing_class_error = "*** Unknown syntax: BaseModel.create()"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("BaseModel.create()"))
            self.assertEqual(missing_class_error, output.getvalue().strip())

    def test_create_the_object(self):
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_show(unittest.TestCase):
    """The unittests testing the show method of the HBNB command interpreter"""
    ...
    def test_show_the_missing_class(self):
        missing_class_error = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_show_the_invalid_class(self):
        missing_class_error = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_show_the_missing_id_space_notation(self):
        missing_class_error = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_the_missing_id_dot_notation(self):
        missing_class_error = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_that_show_no_instances_in_space_notation(self):
        missing_class_error = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_update(unittest.TestCase):
    ...
    def test_update_missing_attr_name_space_notation(self):
        missing_class_error = "** attribute name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testId = output.getvalue().strip()
    ...
    def test_update_missing_attr_value_space_notation(self):
        missing_class_error = "** value missing **"
        with patch("sys.stdout", new=StringIO()) as output:
