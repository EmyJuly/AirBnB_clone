...
class TestFileStorage_methods(unittest.TestCase):
    ...
    def test_new(self):
        ...
        self.assertIn("Place." + env.id, models.storage.all().keys())
        self.assertIn(env, models.storage.all().values())
    ...
    def test_save(self):
        ...
        with open("file.json", "r") as f:
            ...
            self.assertIn("Place." + env.id, save_text)
    ...
    def test_reload(self):
        ...
        self.assertIn("Place." + env.id, objs)
